...
export const COLLECTIONS: Video[] = [
    { id: 1, image: 'assets/image/image1.jpg', description: 'The story of a terminally ill man who wishes to live life to the full before the inevitable occurs, as told by his best friend.The story of a terminally ill man who wishes to live life to the full ', lastSeen: 1, videoLink: 'videoLink' },
    { id: 2, image: 'assets/image/image5.jpg', description: 'this is description', lastSeen: 2, videoLink: 'videoLink' },
    { id: 3, image: 'assets/image/image3.jpg', description: 'this is', lastSeen: 3, videoLink: 'videoLink' },
    { id: 4, image: 'assets/image/image6.jpg', description: 'this is', lastSeen: 4, videoLink: 'videoLink' },
    { id: 5, image: 'assets/image/image7.jpg', description: 'this is description', lastSeen: 1, videoLink: 'videoLink' }
];